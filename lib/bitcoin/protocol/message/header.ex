defmodule Bitcoin.Protocol.Message.Header do
  ...
  @type t :: %__MODULE__{
          ...
          # sha256(sha256(payload)) first four bytes
          checksum: non_neg_integer
        }

  @spec parse(binary) :: t
  def parse(
        <<network_identifier::unsigned-little-integer-size(32), command::bytes-size(12),
  ...
  def checksum(payload) do
    <<result::unsigned-little-integer-size(32), _::binary>> =
