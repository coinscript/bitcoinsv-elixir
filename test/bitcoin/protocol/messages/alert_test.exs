defmodule Bitcoin.Protocol.Messages.AlertTest do
  ...
  test "parses the alert payload" do
    ...
    assert alert.comment == ""
    assert alert.expiration == 1_329_792_435
    assert alert.id == 1010
    assert alert.max_ver == 61000
    assert alert.min_ver == 10000
    assert alert.relay_until == 1_329_620_535
    assert alert.reserved == ""
    assert alert.set_cancel == []
  ...
  test "parses array of ints propely" do
    payload =
      ""
      |> Base.decode16!()

    struct = %Alert{
      cancel: 2_147_483_646,
      comment: "",
      expiration: 2_147_483_647,
      id: 2_147_483_647,
      max_ver: 2_147_483_647,
      min_ver: 0,
      payload:
        "010000000000000000000000FFFFFF7F00000000FFFFFF7FFEFFFF7F01FFFFFF7F00000000FFFFFF7F00FFFFFF7F002F555247454E543A20416C657274206B657920636F6D70726F6D697365642C207570677261646520726571756972656400"
        |> Base.decode16!(),
      priority: 2_147_483_647,
      relay_until: 0,
      reserved: "",
      set_cancel: [2_147_483_647],
      set_sub_ver: [],
      signature:
        "30440220653FEBD6410F470F6BAE11CAD19C48413BECB1AC2C17F908FD0FD53BDC3ABD5202206D0E9C96FE88D4A0F01ED9DEDAE2B6F9E00DA94CAD0FECAAE66ECF689BF71B50"
        |> Base.decode16!(),
